...
export const meta: BlogPostMeta = {
  ...
  author: { name: 'The Local Creator Crew Team', role: 'Local Creator Crew' },
  date: '2026-05-20',
  readingMinutes: 5,
  coverImage:
...
export default function Post() {
  return (
    <>
      ...
      <p>
        When you evaluate a creator on Local Creator Crew, skim past the headline number and look at the work.
      ...
      <p>
        This is exactly why we built Local Creator Crew without follower gatekeeping. Campaigns can set a
