 ...
 * in the Local Creator Crew backend — so this is an intentional, friendly explainer.
 */
    ...
    <div className="mx-auto max-w-6xl space-y-6">
      ...
      <div className="flex flex-col items-center rounded-2xl border border-dashed border-hair-strong bg-card p-10 text-center shadow-card">
        ...
        <p className="mt-1.5 max-w-md text-sm text-muted">
          User and signup analytics live in the Local Creator Crew backend, not the Analytics Hub. This hub
