...
export const metadata: Metadata = buildMetadata({
  ...
  description: 'How Local Creator Crew collects, uses, and protects your personal information.',
  path: '/privacy',
  ogEyebrow: 'Legal',
});
...
export default function PrivacyPage() {
  return (
    <LegalPage
      ...
      intro="This Privacy Policy explains what information Local Creator Crew collects, how we use it, and the choices you have. By using Local Creator Crew you agree to the practices described here."
    >
      ...
      <p>
        ...
        rights, contact us at <a href="mailto:privacy@localcreatorcrew.com">privacy@localcreatorcrew.com</a>.
      </p>
      ...
      <h2>8. Children</h2>
      <p>Local Creator Crew is not directed to children under 16, and we do not knowingly collect their data.</p>
      ...
      <h2>10. Contact</h2>
      <p>
        Questions about privacy? Email <a href="mailto:privacy@localcreatorcrew.com">privacy@localcreatorcrew.com</a>{' '}
