...
export const metadata: Metadata = buildMetadata({
  title: 'Cookie Policy',
  description: 'How and why Local Creator Crew uses cookies and similar technologies.',
  path: '/cookies',
  ogEyebrow: 'Legal',
});
...
export default function CookiesPage() {
  return (
    <LegalPage
      ...
      intro="This Cookie Policy explains how Local Creator Crew uses cookies and similar technologies to recognise you and improve your experience."
    >
      ...
      <p>
        ...
        <a href="mailto:privacy@localcreatorcrew.com">privacy@localcreatorcrew.com</a> or see our{' '}
