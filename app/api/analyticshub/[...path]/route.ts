...
const DEFAULT_PROJECT = { name: 'Collably', primary: '#0064E0', accent: '#FF6A3D' };
...
async function buildStatus(): Promise<HubStatus> {
  ...
  const connections = configured
    ? [
        ...
        { source: 'users' as SourceId, connected: false, reconnectNeeded: false, note: 'Not available in this app — signups live in the Collably backend, not this dashboard.' },
      ]
    : [];
