...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex h-auto items-center gap-1 overflow-x-auto border-b border-hair text-muted',
      className,
    )}
    {...props}
  />
