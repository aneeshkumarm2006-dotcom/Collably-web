...
function UsersNote() {
  return (
    <div className="flex flex-col justify-center rounded-xl border border-dashed border-hair-strong bg-card p-4 shadow-card">
      ...
      <p className="mt-1 text-xs text-faint">Signups live in the Collably backend, not this hub.</p>
    </div>
  );
}
  ...
  return (
    <section className="rounded-xl border border-hair bg-card p-4 shadow-card">
      ...
      <p className="text-sm text-muted">
        User analytics aren&apos;t part of this dashboard — signups live in the Collably backend.
      </p>
      <Link
