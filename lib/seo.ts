...
export const SITE_NAME = 'Local Creator Crew';
export const SITE_URL = config.siteUrl;
export const SITE_TAGLINE = 'The local collab marketplace';
export const SITE_DESCRIPTION =
  'Local Creator Crew is the marketplace where local businesses run gifting campaigns and creators earn real rewards. No agencies, no follower gatekeeping.';

/** Public social handles (used in footer + Organization `sameAs`). */
export const SOCIAL_LINKS = {
  instagram: 'https://instagram.com/localcreatorcrew',
  twitter: 'https://twitter.com/localcreatorcrew',
  linkedin: 'https://linkedin.com/company/localcreatorcrew',
} as const;
...
export interface PageMetaInput {
  /** Page title: the root template appends "· Local Creator Crew". Omit on the homepage. */
  title?: string;
  description: string;
