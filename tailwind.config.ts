  ...
  theme: {
    extend: {
      colors: {
        ...
        // Marketing/app accent hues (orange / purple / mint) used for tinted chips & icons.
        warm: { DEFAULT: 'var(--accent-warm)', soft: 'var(--accent-warm-soft)' },
        grape: { DEFAULT: 'var(--accent-purple)', soft: 'var(--accent-purple-soft)' },
        mint: { DEFAULT: 'var(--accent-mint)', soft: 'var(--accent-mint-soft)' },
      ...
      keyframes: {
        ...
        'cb-float': { '0%,100%': { transform: 'translateY(0)' }, '50%': { transform: 'translateY(-15px)' } },
        'cb-float-b': {
          '0%,100%': { transform: 'translateY(0) rotate(0deg)' },
          '50%': { transform: 'translateY(13px) rotate(8deg)' },
        },
        'cb-fill': { '0%': { width: '14%' }, '46%,58%': { width: '82%' }, '100%': { width: '14%' } },
        'cb-pulse': {
      ...
      animation: {
        ...
        'cb-float': 'cb-float 6s ease-in-out infinite',
        'cb-float-b': 'cb-float-b 7s ease-in-out infinite',
